...
export const NumericInputCustom: React.FC<INumericInputCustom> = React.memo((props) => {
  ...
  return (
    <View className="flex-row border items-center rounded-md border-gray-400 py-0.5 max-w-[156px]">
      <TouchableOpacity
        onPress={handleDecrement}
        className="justify-center px-5 items-center border-r-2 border-gray-300">
      ...
      <TouchableOpacity
        ...
        className="justify-center items-center px-5 border-l-2 border-gray-300">
        <Text className="text-gray-500 text-base text-center font-medium">+</Text>
      </TouchableOpacity>
    </View>
  );
